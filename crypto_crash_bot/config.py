...
MANUAL_API_TIMEOUT_SECONDS = int(os.environ.get("MANUAL_API_TIMEOUT_SECONDS", "6"))
MANUAL_CONNECT_TIMEOUT_SECONDS = int(os.environ.get("MANUAL_CONNECT_TIMEOUT_SECONDS", "2"))
MANUAL_READ_TIMEOUT_SECONDS = int(os.environ.get("MANUAL_READ_TIMEOUT_SECONDS", "4"))
BACKGROUND_API_TIMEOUT_SECONDS = int(os.environ.get("BACKGROUND_API_TIMEOUT_SECONDS", "15"))

TOKEN_RESOLVE_CACHE_TTL = int(os.environ.get("TOKEN_RESOLVE_CACHE_TTL", "900"))
TOKEN_MENU_CACHE_TTL = int(os.environ.get("TOKEN_MENU_CACHE_TTL", "60"))
